...
<div class="card">
    <div class="card-header border-bottom">
        ...
        <div class="card-title">
            <form action="{{route('admin.blogUpdate',$edit->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="select2-primary" style="z-index: 999999999 !important;">
                                ...
                                <select id="select2success" class="select2 form-select" name="category">
                                    @foreach($cat as $e)
                                    <option value="{{$e->id}}" {{isset($edit)? ($e->id == $edit->category_id ? 'selected' : ''):'' }}>{{$e->category}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
