...
<link rel="stylesheet" href="{{asset('frontend/asset/build/css/intlTelInput.css')}}" />
<!--<link rel="stylesheet" href="{{asset('asset/build/css/demo.css')}}" />-->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/css/intlTelInput.css">


<!--Profile and Edit Profile -->
@if($data=Auth::guard('customer')->user())
              ...
              <div class="left-side-internal-card">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="row">
                      <div class="col-md-6">
                        <a href="#" class="right-side-love-btn1">{{$data->email ??''}}</a>
                      </div>
                      <div class="col-md-6">
                        <a href="#" class="right-side-love-btn2">{{$data->phone ??''}}</a>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-5">
                    ...
                    <h3>{{$data->full_name ??''}}</h3>
                    <p>
                      @foreach(json_decode($data->astrologer->experties) as $expertie)
                      {{ $expertie }}
                      @endforeach
                    </p>
                    <span>Languages:
                      @foreach(json_decode($data->astrologer->language) as $lang)
                      {{ $lang }}
                      @endforeach
                    </span>
                  </div>
                  ...
                  <div class="col-md-7">
                    <div class="row">
                      <div class="col-md-6">
                        <a href="#" class="right-side-love-btn1">{{$data->astrologer->email ?? ''}}</a>
                      </div>
                      <div class="col-md-6">
                        <a href="#" class="right-side-love-btn2">{{$data->astrologer->phone ?? ''}}</a>
                      </div>
                    </div>
                    <div class="astro-three-tab">
                      <div class="row">
                        <div class="col-md-4">
                          <h4>{{$data->astrologer->experience ?? ''}}+</h4>
                          <p>Experience</p>
                        </div>
                        <div class="col-md-4">
                          <h4>{{$data->astrologer->city ?? ''}}</h4>
                          <p>City</p>
                        </div>
                        <div class="col-md-4">
                          <h4>{{$data->astrologer->education ?? ''}}</h4>
                          <p>Education</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6" hidden>
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="astrologer_id" name="astrologer_id" value="{{$data->astrologer_id ?? ''}}">
                        </div>
                      </div>
                      <div class="col-md-6" hidden>
                        <div class="mb-3">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="test" class="form-control" id="first_name" name="first_name" value="{{$data->first_name ?? ''}}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label for="last_name" class="form-label">Last Name</label>
                          <input type="test" class="form-control" id="last_name" name="last_name" value="{{$data->last_name ?? ''}}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="mb-3">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="time" class="form-control" id="dob_time" name="dob_time" value="{{$data->dob_time ?? ''}}">
                        </div>
                      </div>
                      @endif
                    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="otp-form">
          <form id="mysendOTP" action="{{route('sendOTP')}}" method="post" enctype="multipart/form-data">
            @csrf
        ...
        <script src="{{asset('frontend/asset/build/js/intlTelInput.js')}}"></script>
        <!-- <script>
...
<div class="modal fade" id="otpModal" tabindex="-1" aria-labelledby="otpModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="myverifyOTP" action="{{route('verifyOTP')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="modal-body">
          <p id="otpMessage"></p>
          <p id="otpError"></p>
      ...
      success: function(response) {
        ...
        if (response.otp !== 'Invalid or expired OTP') {
          ...
          if (response.role !== 'customer') {
            window.location.href = "{{url('/astrologer')}}";
          } else {
  ...
  <div class="hs_top_header_main_Wrapper">
    <div class="hs_header_logo_left" style="width:40%;">
      <div class="hs_logo_wrappe">
        <!--<a href="index.html"><img src="{{ asset('asset/images/header/logo.png') }}" class="img-responsive" alt="logo" title="Logo" /></a>-->
        <h2><a href="{{route('login')}}" style="    top: 15px;
    position: relative;
    color:black;
">Astrology</a></h2>
      </div>
    ...
    <div class="hs_header_logo_right" style="width:60%;">
      <nav class="hs_main_menu">
        <ul>
          <li>
            <a class="gradients" href="{{route('astrologer')}}">
              Astrologer</a>
          </li>
          <li>
            <a class="gradients" href="{{route('consultHistroy')}}">
              Download App</a>
          </li>

          <li>
            <a class="menu-button" href="{{route('zodiacsigns')}}">Zodiac Signs </a>
          </li>
          <li>
            <a class="menu-button" href="{{route('contactus') }}">Contact Us </a>
          </li>
                ...
                <a class="dropdown-item" href="#">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <span class="fw-semibold d-block">{{$data->full_name ?? ''}}</span>
          ...
          <li>
            ...
            <a class="card-icon-menu" href="{{route('payment') }}"><i class="fa fa-credit-card-alt" aria-hidden="true"></i>
            </a>
          </li>
          <!--                                <li>-->
          ...
          <!--                                    <a class="menu-button" href="{{route('blog') }}">Blog </a>-->
...
<!--                                        <li>-->
          ...
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.aries')}}">Aries</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.chinese')}}">Chinese</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.chinese_single')}}">Chinese-Single</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.crystal')}}">Crystal</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.kundli_dosh')}}">Kundli-Dosh</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.numerology')}}">Numerology</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.palm')}}">Palm</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.tarot')}}">Tarot</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.tarot_single')}}">Tarot-Single</a>-->
          <!--    </li>-->
          <!--    <li>-->
          <!--        <a class="menu-button" href="{{route('service.vastu_shastra')}}">Vastu-Shastra</a>-->
          <!--    </li>-->
          <!--</ul>-->
          <!--</li>-->
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-6 col-sm-6">
        <div class="hs_logo">
          <!--<a href="index.html"><img src="{{ asset('asset/images/header/logo.png') }}" alt="Logo" title="Logo"></a>-->
          <h2 style="padding-top:10px;"><a href="{{route('login')}}" style="
    color:black;
">Astrology</a></h2>
        </div>
      </div>
      <div class="col-xs-6 col-sm-6">
        <div class="cd-dropdown-wrapper">
          ...
          <nav class="cd-dropdown">
            <h2><a href="{{route('login')}}">Astrology</a></h2>
            ...
            <ul class="cd-dropdown-content">
              ...
              <!--    </form>-->
              <!--</li>-->
              <li><a class="gradients" href="{{route('astrologer')}}">
                  Astrologer</a></li>
              <li>
                <a class="gradients" href="{{route('consultHistroy')}}">
                  Download App</a>
              ...
              <li>
                <a href="{{route('zodiacsigns')}}">Zodiac Signs </a>
              </li>
              <li>
              ...
              <!--        <li>-->
              <!--            <a href="{{ route('service.aries') }}">Aries</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.chinese')}}">Chinese</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.chinese_single')}}">Chinese-Single</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.crystal')}}">Crystal</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.kundli_dosh')}}">Kundli-Dosh</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.numerology')}}">Numerology</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.palm')}}">Palm</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.tarot')}}">Tarot</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--        <li>-->
              ...
              <!-- .has-children -->
              <!--        <li>-->
              <!--            <a href="{{route('service.vastu_shastra')}}">Vastu-Shastra</a>-->
              <!--        </li>-->
              <!-- .has-children -->
              <!--    </ul>-->
