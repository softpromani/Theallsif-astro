        ...
        <div class="container ">
            <div class="row ">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 right-side-astro ">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                        <h3 style="margin-bottom: 20px;">Showing <?php echo e($astrologers->count()); ?> Astrologers</h3>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                        <div class="card-astro">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <a href="<?php echo e(route('details',$astrologer->id)); ?>">
                                        <?php if($astrologer->image !=null): ?>
                                        <img class="card-astro-img" src="<?php echo e(asset('images/'.$astrologer->image)); ?>" alt="blog_img">
                                        <?php else: ?>
                                        <img class="card-astro-img" src="<?php echo e(asset('frontend/asset/images/content/news_img1.jpg')); ?> " alt="blog_img ">
                                        <?php endif; ?>
                                    </a>
                                </div>
                                <div class="col-md-7">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h3 class="astro-title-name"><?php echo e($astrologer->full_name ?? ''); ?></h3>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <span>Exp- <?php echo e($astrologer->experience ?? ''); ?>+</span><br>
                                    <span><?php $__currentLoopData = json_decode($astrologer->experties); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expertie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($expertie ??''); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></span><br>
                                    <span><?php $__currentLoopData = json_decode($astrologer->language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($lang ??''); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></span><br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="astro-call-btn">
                                                <a href="#" <?php if($data=Auth::guard('customer')->user()): ?> disable <?php endif; ?> >Call $<?php echo e($astrologer->costs->astrologer_cost ??''); ?>/Min,</a>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="astro-chat-btn">
                                                <a href="<?php echo e(url('chatify',$astrologer->customer_astrologer->id ??'')); ?>">Chat <?php echo e($astrologer->costs->astrologer_cost ?? ''); ?>/Min,</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/news_img1.jpg')); ?> " alt="blog_img ">-->
<!--                        <ul>-->
...
<!--                <div class="hs_lest_news_box_wrapper ">-->
<!--                    <div class="hs_lest_news_img_wrapper ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/news_img2.jpg ')); ?>" alt="blog_img ">-->
<!--                        <ul>-->
<!--                            <li><a href="# "><i class="fa fa-phone "></i>&nbsp; Call Now</a></li>-->
<!--                        </ul>-->
<!--                    </div>-->
...
<!--                <div class="hs_lest_news_box_wrapper ">-->
<!--                    <div class="hs_lest_news_img_wrapper ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/news_img3.jpg ')); ?>" alt="blog_img ">-->
<!--                        <ul>-->
<!--                            <li><a href="# "><i class="fa fa-phone "></i>&nbsp; Call Now</a></li>-->
<!--                        </ul>-->
<!--                    </div>-->
...
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon1.png')); ?>" alt="icon1 ">-->
<!--                    </div>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon2.png')); ?> " alt="icon2 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Taurus</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon3.png')); ?> " alt="icon3 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Gemini</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon4.png')); ?> " alt="icon4 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Cancer</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon5.png ')); ?>" alt="icon5 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>leo</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon6.png ')); ?>" alt="icon6 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Virgo</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon7.png' )); ?>" alt="icon7 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Libra</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon8.png' )); ?>" alt="icon8 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Scorpio</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon9.png')); ?> " alt="icon9 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Sagittairus</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon10.png ')); ?>" alt="icon10 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Capricorn</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon11.png ')); ?>" alt="icon11 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Aquarius</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                <div class="hs_sign_box ">-->
<!--                    <div class="sign_box_img ">-->
<!--                        <img src="<?php echo e(asset('frontend/asset/images/content/icon12.png')); ?> " alt="icon12 ">-->
<!--                    </div>-->
<!--                    <div class="sign_box_cont ">-->
<!--                        <h2>Pisces</h2>-->
<!--                        <p>31 Mar - 12 Oct</p>-->
...
<!--                    <img src="<?php echo e(asset('frontend/asset/images/content/about_img.jpg ')); ?>" alt="about_img " />-->
<!--                </div>-->
<!--            </div>-->
<!--            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">-->
<!--                <div class="hs_about_heading_main_wrapper ">-->
...
<!--                                        <img src="<?php echo e(asset('frontend/asset/images/content/testi_client_img1.jpg ')); ?>" class="img-responsive " alt="section3_t2__img " />-->
<!--                                        <h5>Ralph Rios</h5>-->
...
<!--                                    <div class="testimonial_slider_content ">-->
<!--                                        <img src="<?php echo e(asset('frontend/asset/images/content/testi_client_img2.jpg ')); ?>" class="img-responsive " alt="section3_t2__img " />-->
<!--                                        <h5>Ralph Rios</h5>-->
<!--                                        <small>Creative Director</small>-->
<!--                                        <h4><span>&nbsp;</span></h4>-->
<!--                                        <p>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer galley of type.</p>-->
...
<?php $__env->startSection('script-area'); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layout.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Theallsif-astro\resources\views/frontend/home.blade.php ENDPATH**/ ?>