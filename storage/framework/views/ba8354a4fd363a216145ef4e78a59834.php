...
<div class="card">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog_read')): ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.blogStore')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div class="select2-primary" style="z-index: 999999999 !important;">
                                ...
                                <select id="select2success" class="select2 form-select" name="category">
                                    <?php $__currentLoopData = $cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($e->id); ?>"><?php echo e($e->category); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $('.datatables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo route('admin.blog'); ?>",
...
<script>
    $(document).ready(function() {
        $(document).on('change', '.is_active', function() {
            ...
            var newurl = "<?php echo e(url('/admin/blog-status')); ?>/" + statusId;
            $.ajax({
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\Theallsif-astro\resources\views/admin/blog/blog_list.blade.php ENDPATH**/ ?>