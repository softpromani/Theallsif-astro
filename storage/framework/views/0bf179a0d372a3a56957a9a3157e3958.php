...
">Astrology</a></h2>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                        <div class="hs_download_wrapper ">
                            ...
                            <div class="hs_download_btn_wrapper ">
                                <a href="# ">
                                    <img src="<?php echo e(asset('frontend/asset/images/content/App-Store.png')); ?>" class="img-responsive " alt="App_Store_img ">
                                </a>
                                <a href="# ">
                                    <img src="<?php echo e(asset('frontend/asset/images/content/Google-Play.png')); ?> " class="img-responsive " alt="Google_Play_img ">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row ">
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
                    <div class="footer_bottom_cont_wrapper ">
                        <p>© Copyright 2023 by Astrology. All right Reserved - Design By <a href="# ">theAllsafe</a></p>
                    </div>
                </div>
    ...
    </div><?php /**PATH E:\Theallsif-astro\resources\views/frontend/include/footer.blade.php ENDPATH**/ ?>